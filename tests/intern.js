...
define({
  ...
  // NOTE: this config won't work for funcitonal testing
  // b/c it uses the esri loader, so no sauce/selenium properties are required
  ...
  // NOTE: functional tests won't work w/ esri loader
